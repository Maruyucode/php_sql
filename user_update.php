...
if (
  ...
  !isset($_POST['kanri_flg']) || 
  !isset($_POST['life_flg']) || 
  !($_POST['kanri_flg'] == '0' || $_POST['kanri_flg'] == '1') ||
...
//データ登録SQL作成
$sql = 'UPDATE user_table SET name=:a1, lid=:a2, lpw=:a3, kanri_flg=:a4, life_flg=:a5 WHERE id=:a6';
...
$stmt->bindValue(':a6', $target_user_id, PDO::PARAM_INT);
$status = $stmt->execute();
